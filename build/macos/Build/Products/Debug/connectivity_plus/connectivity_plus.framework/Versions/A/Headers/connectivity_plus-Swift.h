...
SWIFT_CLASS("_TtC17connectivity_plus18ConnectivityPlugin")
...
SWIFT_CLASS("_TtC17connectivity_plus31PathMonitorConnectivityProvider") SWIFT_AVAILABILITY(macos,introduced=10.14)
