...
const Post = _i1.ObjectTypeDefinitionNode(
  ...
  fields: [
    _i1.FieldDefinitionNode(
      name: _i1.NameNode(value: 'postTitle'),
      directives: [],
      args: [],
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
    ...
    _i1.FieldDefinitionNode(
      name: _i1.NameNode(value: 'postDescription'),
      directives: [],
      args: [],
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
    ...
    _i1.FieldDefinitionNode(
      name: _i1.NameNode(value: 'postedBy'),
      directives: [],
      args: [],
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'User'),
    ...
    _i1.FieldDefinitionNode(
      name: _i1.NameNode(value: 'totalComments'),
      directives: [],
      args: [],
      type: _i1.NamedTypeNode(
...
const Comment = _i1.ObjectTypeDefinitionNode(
  ...
  fields: [
    ...
    _i1.FieldDefinitionNode(
      name: _i1.NameNode(value: 'commentedBy'),
      directives: [],
      args: [],
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'User'),
...
const PostResponse = _i1.ObjectTypeDefinitionNode(
  name: _i1.NameNode(value: 'PostResponse'),
  directives: [],
  interfaces: [],
  fields: [
    _i1.FieldDefinitionNode(
...
const Query = _i1.ObjectTypeDefinitionNode(
  ...
  fields: [
    _i1.FieldDefinitionNode(
      name: _i1.NameNode(value: 'tryQuery'),
      directives: [],
      args: [],
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'User'),
